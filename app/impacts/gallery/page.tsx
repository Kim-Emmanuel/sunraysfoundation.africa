...
export const metadata: Metadata = {
	...
	description:
		"Explore our photo and video gallery showcasing the impact of Sun Rays Foundation's work in South Sudan. See the faces and stories of the communities we empower through education and sustainable development.",
	keywords:
		"Sun Rays Foundation, Gallery, photos, videos, South Sudan, education, sustainable development, community empowerment, impact, stories, non-profit, charity, humanitarian aid",
	// Open Graph / Facebook
	openGraph: {
		title: "Gallery | Sun Rays Foundation",
		description:
